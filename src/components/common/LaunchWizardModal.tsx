...
export const LaunchWizardModal: React.FC<LaunchWizardModalProps> = ({
  ...
  const steps = [
    ...
    { id: 4, title: 'Multi-Currency Wallet Activated', view: 'wallet' as ViewType },
    { id: 5, title: 'DEOS Coin Deposit & Conversion Completed', view: 'deposit' as ViewType },
    { id: 6, title: 'Growth Plan Membership Activated', view: 'settings' as ViewType },
    { id: 7, title: 'Subdomain Provisioned (username.deos.com)', view: 'builder' as ViewType },
    ...
    { id: 11, title: 'CRM Lead Capture & Form Funnel Activated', view: 'crm' as ViewType },
    { id: 12, title: 'Select First Marketplace Product to Promote', view: 'marketplace' as ViewType },
    { id: 13, title: 'Binary Leg Preference Configured (2:1 Balancing)', view: 'binary' as ViewType },
    { id: 14, title: 'Digital Entrepreneur Academy Lesson 1 Completed', view: 'academy' as ViewType },
